...
apple = pygame.Rect(random.randint(50, 700), random.randint(80, 500), random.randint(30, 50), random.randint(30, 50))
score = 0
lives = 3
message = ""
messageTimer = 0
...
while running:
    ...
    if not gameOver:
        ...
        if player.colliderect(apple):
            ...
            if score >= 6 and score <= 7:
                ...
                message = f"Wow, level 25?! Not bad.."
            elif score % 50 == 0:
                message = f"Level 50?! Try-hard..."
            elif score % 75 == 0:
                message = f"Time to take a nap!!"
            appleStreak += 1
    ...
    if message != "":
        ...
        screen.blit(messageText, (170, 500))
    if bulletReady:
    ...
    if not gameOver:
        ...
        for enemy in enemies:
            pygame.draw.polygon(screen, "purple", [(enemy.x+15, enemy.y), (enemy.x, enemy.y+30), (enemy.x+30, enemy.y+30)])
        if bulletActive:
